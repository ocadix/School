...
namespace SchoolFronted.Pages
{
    public class InscriptionModel(IHttpClientFactory clientFactory) : PageModel
    {
        ...
        [BindProperty]
        public RegisterSubjectViewModelInscription NewInscription { get; set; } = new RegisterSubjectViewModelInscription(); // Cambia el tipo aqu�
        ...
        public async Task<IActionResult> OnPostDeleteAsync(string id)
        {
            ...
            try
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "No se proporcion� un c�digo de inscripci�n para eliminar.");
                    await LoadInscriptionAsync();
                    return Page();
                }
            ...
            {
                ModelState.AddModelError(string.Empty, $"Error al eliminar la inscripci�n: {ex.Message}. Verifique la conexi�n o el c�digo de la inscripci�n.");
                await LoadInscriptionAsync();
                return Page();
            }
        ...
        public async Task<IActionResult> OnPostRegister()
        {
            if (NewInscription == null)
                ModelState.AddModelError(string.Empty, $"Error al registrar la inscripci�m.");
